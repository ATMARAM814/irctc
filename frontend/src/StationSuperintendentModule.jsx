...
function StationSuperintendentModule({ user, onLogout }) {
  ...
  const renderProfile = () => (
    <section className="ss-panel-card">
      <div className="ss-page-header">
        <h2>Profile</h2>
        <span className="ss-view-only">View Only</span>
      </div>

      <div className="ss-profile-grid">
        <article>
          <label>Name</label>
          <strong>{ssName}</strong>
        </article>
        <article>
        ...
        <article>
          ...
          <strong>{ssProfileSeed.designation}</strong>
        </article>
        <article>
          <label>Station</label>
          <strong>{ssProfileSeed.station}</strong>
        </article>
        <article>
          <label>Reporting Officer (TI)</label>
          <strong>{ssProfileSeed.reportingOfficer}</strong>
        </article>
      </div>
    </section>
  );
